...
! function (n) {
    ...
    function l(t, e, o, i) {
        n("#" + o.pauseButton).click(function () {
            ...
            "resume" != n(this).val() ? (n("#" + o.pauseButton).val("resume").html("<i class=\"fa fa-play\"></i>"), clearInterval(window["timer_" + e + t.attr("id")])) : "resume" == n(this).val() && (n("#" + o.pauseButton).val("pause").html("<i class=\"fa fa-pause\"></i>"), window["timer_" + e + t.attr("id")] = setInterval(function () {
                i(t, o)
            }, 1e3 * o.tickInterval))
        })
    }
